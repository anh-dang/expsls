...
EXP_SYN_NON_INTERP_COMPARE_CONFIGS['kappa'] =  [1500, 1024, 512, 200, 100, 50] #[1024, 512, 256] [200, 100, 50]
EXP_SYN_NON_INTERP_COMPARE_CONFIGS['runs'] = [0,1,2]
EXP_SYN_NON_INTERP_COMPARE_CONFIGS['batch_size'] = [-10/8]
...
EXP_SYN_NON_INTERP_COMPARE_CONFIGS['variance'] = [0, 1e-6, 1e-4, 1e-2, 1] #[1e-2, 1e-4, 1e-5, 1e-6] [1,1e-2,1e-4]
opt_list = []
